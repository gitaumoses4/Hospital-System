 ...
 */
public class EditMedicalTreatmentForm extends JPanel {

    public JLabel treatmentIdLabel = new JLabel("Treatment ID");
    ...
    public MTextField treatmentIdField = new MTextField(15);
    ...
    public EditMedicalTreatmentForm() {
        ...
        panels.add(Tools.formLayout(treatmentIdLabel, treatmentIdField, 40, 5, 10));
